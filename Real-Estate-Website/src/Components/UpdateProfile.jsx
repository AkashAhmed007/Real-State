...
const UpdateProfile = () => {
  return (
    <>
    <div className="mt-10">
      <div className="max-w-md p-8 mx-auto sm:flex sm:space-x-6 dark:bg-gray-50 dark:text-gray-800 border-gray-500 border mt-20">
        ...
        <div className="flex flex-col justify-center space-y-4">
          <div>
            <h2 className="text-2xl font-bold text-green-300 border-b border-green-400">Your Profile</h2>
    ...
    <h3 className="text-center mt-5">Update your profile</h3>
    <div className="mt-0">
    <Register></Register>
    </div>
    </>
