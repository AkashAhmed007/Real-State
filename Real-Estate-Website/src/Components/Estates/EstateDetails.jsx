...
const EstateDetails = () => {
  ...
  return (
    <div className="mt-28 min-h-screen">
      <Helmet>
        <title>Realty-Hub | EstatesDetails</title>
      </Helmet>
      <section className="dark:bg-gray-100 dark:text-gray-800">
        <div className="container flex flex-col-reverse mx-auto lg:flex-row">
          <div className="flex flex-col px-6 py-8 space-y-2 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 dark:bg-violet-600 dark:text-gray-50">
