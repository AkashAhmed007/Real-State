...
<footer className="divide-y dark:bg-gray-100 dark:text-gray-800">
	<div className="container flex flex-col justify-between py-10 mx-auto sm:space-y-8 sm:p-10 p-8 lg:flex-row lg:space-y-0 bg-black text-white">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">All-in-One Realty Hub</span>
			</a>
		</div>
	...
	<div className="w-full py-6 text-sm text-center dark:text-gray-600 bg-gray-200">© 1968 Company Co. All rights reserved.</div>
</footer>
  );
};
